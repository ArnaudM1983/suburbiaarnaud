...
function Scene(
    ...
    useEffect(() => {
        ...
        function setZoom() {
            ...
            // Ajuste le facteur de zoom pour éloigner la caméra sur les petits écrans
            const scale = screenWidth < 768 
                ? Math.max(Math.min(1200 / screenWidth, 2.5), 1.5) // Plus éloigné sur mobile
                : Math.max(Math.min(1000 / screenWidth, 2.2), 1);  // Valeurs originales
        ...
        <group>
            ...
            <group ref={originRef}>
                <group ref={containerRef} position={[-0.45, 0.1, -0.635]}>
                    <group position={[0, -0.086, 0.635]}>
                        ...
                        <Hotspot isVisible={!animating && showHotspot.back} position={[0, .35, -0.9]} color="#46ACFA" />
            ...
            >
                <Html
                    ...
                    transform zIndexRange={[1, 0]} occlude="blending">
                    <WavyPaths />
                </Html>
            </group>
